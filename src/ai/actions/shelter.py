...
from src.shelter.helpers import (
...
class SeekShelterAction(Action):
    ...
    def execute(self, creature) -> bool:
        ...
        if ref is None:
            if threat is not None:
                from src.utils.movement_helpers import move_away_from
    ...
    def calculate_utility(self, creature) -> float:
        ...
        if is_creature_sheltered(creature):
            from src.utils.creature_helpers import needs_nest_feed, nest_has_usable_food
